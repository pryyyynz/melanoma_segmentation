...
class LFNet(nn.Module):
    ...
    def forward(self, x):
        ...
        x6 = F.interpolate(x6, size=(124, 124))
        ...
        x8 = F.interpolate(x8, size=(124, 124))
        ...
        x10 = F.interpolate(x10, size=(124, 124))
        ...
        x12 = F.interpolate(x12, size=(126, 126))
